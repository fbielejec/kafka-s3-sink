...
- POST /values {"value" : 2 } returns HTTP/202 and an id (UUID) for the accepted value
- PUT /values/:id {"operation" : <OPERATION>, "value" : 3 } where OPERTATION can be ADD or MULTIPLY, it returns HTTP/202
